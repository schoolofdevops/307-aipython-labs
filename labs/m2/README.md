# Module 2 — Setting Up a Modern Python Environment

This module's lab does not use files from this folder. Instead, you build a new project of
your own at `~/platformops`, following `lesson.md` and `lab.md` on the course site.

This folder holds:

- `checks.json` — machine-readable checks for the lab's success state (used by course tooling).
